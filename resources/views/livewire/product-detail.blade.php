        ...
        <div class="col">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Detail the Product</li>
                </ol>
              </nav>
        </div>
    </div>
                    ...
                    <table class="table" style="border-top : hidden">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                wire:model="jumlah_pesanan" value="{{ old('jumlah_pesanan') }}" required autocomplete="name" autofocus>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                wire:model="nama" value="{{ old('nama') }}" autocomplete="name" autofocus>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                wire:model="nomor" value="{{ old('nomor') }}" autocomplete="name" autofocus>
